...
| F-X097 | Preserve namespace-scoped drawings and complex fields in comparison | M | in-progress | codex |
...
| F-X103 | Accept standard TOC switches and report rebuild diagnostics | M | pending | - |
