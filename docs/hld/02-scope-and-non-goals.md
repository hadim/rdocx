...
| DOCX-035 | tables | floating, bidirectional, autofit, and advanced table layout | Y | Y | Y | Y | Y | all | P | P | Y | Y | B | B | B | partial | implementation:`crates/rdocx-oxml/src/table.rs`,implementation:`crates/rdocx/src/table.rs`,implementation:`crates/rdocx-layout/src/table.rs`,test:`crates/rdocx/tests/integration_test.rs`,boundary:floating table placement and wrap are the remaining layout and render work and stay with F-268b under its F-268 parent | F-268 |
