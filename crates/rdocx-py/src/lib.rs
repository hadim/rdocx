...
use document::{
    ...
    PyHeaderFooterVariant, PyHyperlink, PyLayoutFragment, PyLayoutPage, PyRevision, PyRunPosition,
    PyRunRange, PySection, PyStory, PyStoryItem, PyStyle, PyTocRebuildReport,
};
